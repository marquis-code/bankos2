    ...
    <div class="min-h-screen bg-gradient-to-br from-[#F1F7FD] via-[#E9F2FA] to-[#D7F4D7]">
      <div class="flex flex-col md:flex-col lg:flex-col 2xl:flex-row justify-between space-y-8 lg:space-y-0 lg:space-x-8">
       ...
       <section class="md:flex space-y-6 md:space-y-0  lg:space-y-0 w-full gap-x-10 justify-between items-start ">
        <div class="bg-white p-4 lg:p-6 rounded-xl  md:w-6/12 lg:w-8/12">
          <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <div class="text-left w-full">
             <div class="flex space-y-3 xl:space-y-0 justify-between items-center w-full">
              <div>
                  <h2 class="text-[#2E3A59]">SAVINGS ACCOUNT</h2>
              </div>
              <div class="bg-[#020C24] flex items-center py-2 px-3 rounded-lg mt-4 sm:mt-0 xl:ml-4">
              ...
              <h1 class="text-2xl 2xl:text-4xl text-[#020C24] flex items-center gap-x-2 font-medium mt-2">₦34,950.00 <span><svg width="13" height="10" viewBox="0 0 13 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p class=""><span class="text-[#C4C4C4] text-sm">Ledger Balance:</span> <span class="text-[#000000] text-lg xl:text-xl">₦250,890.00</span></p>
            </div>
          </div>
          <div class="flex md:space-x-4 w-full">
            <div>
              <NuxtLink to="/dashboard/transfer" class="w-full text-sm sm:w-auto bg-[#2C64E3] text-white px-4 py-3 rounded-lg flex  items-center gap-x-3">
            ...
            <button class="w-full sm:w-auto text-sm bg-[#D7E5FF] text-[#2C64E3] px-4 py-3 rounded-lg flex  items-center gap-x-3">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="bg-[#D8FF6F] md:w-6/12 lg:w-96  border-white border-2 rounded-3xl p-6 relative flex flex-col justify-between">
          <h3 class="text-2xl font-medium text-[#2E3A59]  max-w-xs mb-6">
        ...
        <div class="2xl:w-1/3 space-y-8 lg:bg-white/95  xl:h-screen xl:overflow-y-auto xl:custom-scrollbar xl:no-scrollbar  max-w-7xl mx-auto">
                <div class="lg:p-6 ">
                          ...
                          <div class="relative mt-12">
                            ...
                            <div class="bg-white text-black rounded-lg p-4 flex justify-between items-center relative z-10">
                              <div class="flex items-center space-x-4">
                                ...
                                <div>
                                  <p class="font-semibold text-sm">Mastercard</p>
                                  <p class="text-gray-500 text-sm">**** 6098</p>
                                </div>
                              </div>
                              <p class="text-green-500 text-lg font-bold">$20 750</p>
                            </div>
                          </div>
                        </div>
                      </div>
    <div class="flex flex-wrap space-x-5 gap-x-3 space-y-3  lg:space-y-0 items-center px-6 pb-6 lg:gap-x-0">
    
        <button class="w-full sm:w-auto bg-[#2C64E3] text-xs text-white px-4 py-3 rounded-lg flex  items-center gap-x-3">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            Fund account</button>
          <button class="w-full sm:w-auto bg-[#D7E5FF] text-xs text-[#2C64E3] px-4 py-3 rounded-lg flex  items-center gap-x-3">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10.0003 18.3332C14.5837 18.3332 18.3337 14.5832 18.3337 9.99984C18.3337 5.4165 14.5837 1.6665 10.0003 1.6665C5.41699 1.6665 1.66699 5.4165 1.66699 9.99984C1.66699 14.5832 5.41699 18.3332 10.0003 18.3332Z" stroke="#2C64E3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M13.3301 10.0002H13.3375" stroke="#2C64E3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M9.99607 10.0002H10.0036" stroke="#2C64E3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <!-- <div class=" pr-5 hidden 3xl:block">
          <p class="text-[#687181] text-lg font-semibold pl-6 lg:pl-0 pt-6 lg:pt-0">Cards</p>
         <section class="border border-gray-25 shadow-lg py-3 mb-3 rounded-lg bg-white">
            <div class="p-6">
                <div class="relative bg-blue-600 text-white rounded-2xl p-6 shadow-lg w-full max-w-md">
